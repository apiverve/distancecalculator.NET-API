...
namespace APIVerve
{
    public class DistanceCalculatorAPIClient
    {
        ...
        public DistanceCalculatorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public DistanceCalculatorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(distancecalculatorQueryOptions options)
        {
            try
            {
                if (_isDebug)
